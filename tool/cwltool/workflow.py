...
class WorkflowJob(object):
    ...
    def try_make_job(self,
        ...
        print "viki_flow WorkflowJob()->try_make_job()"
        ...
        try:
            ...
            if inputobj is None:
                _logger.debug(u"[%s] viki job step %s not ready", self.name, step.id)
                return

            if step.submitted:
                return
            _logger.info(u"[%s] viki step starting %s", self.name, step.name)
    ...
    def run(self, runtimeContext):
        print "viki_flow WorkflowJob()->run()"
    ...
    def job(self,
        ...
        print "viki_flow WorkflowJob()->job()"
...
class WorkflowStep(Process):
    ...
    def job(self,
        ...
        print "viki_flow WorkflowStep()->job()"
